...
function draw_bee(model_transform, pointer, graphics_state, t)
{
  ...
  draw_sphere_butt(mult(mult(model_transform, translation(-5,0,0)), scale(2,1,1)), pointer, graphics_state);
  ...
  draw_lt_leg(mult(model_transform, translation(-1.3,-1,-1)), pointer, graphics_state, t);
