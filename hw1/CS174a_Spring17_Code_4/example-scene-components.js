...
function draw_tree(model_transform, pointer, graphics_state, t)
{
  ...
  //draw_segment(model_transform, x, graphics_state, 0);
  //model_transform: only deal with xyz, not rotation. rotation is handled within draw_segment. 
  // the 1th segment
  // draw_segment(model_transform, pointer, graphics_state, 0, per_segment_length, 0, 0);

  // //2nd
  // draw_segment(model_transform, pointer, graphics_state, theta, per_segment_length, 0, per_segment_length);
  // //3rd
  // //model_transform = identity();

  // //why sin negative? because swing to the left first
  // draw_segment(model_transform, pointer, graphics_state, 2*theta, per_segment_length, per_segment_length*Math.sin(-3.14*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180));
  // //4th
  // draw_segment(model_transform, pointer, graphics_state, 3*theta, per_segment_length, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180));
  // //5th
  // draw_segment(model_transform, pointer, graphics_state, 4*theta, per_segment_length, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180)+per_segment_length*Math.sin(-3.14*3*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180)+per_segment_length*Math.cos(3.14*3*theta/180));
  // //6th
  // draw_segment(model_transform, pointer, graphics_state, 5*theta, per_segment_length, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180)+per_segment_length*Math.sin(-3.14*3*theta/180)+per_segment_length*Math.sin(-3.14*4*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180)+per_segment_length*Math.cos(3.14*3*theta/180)+per_segment_length*Math.cos(3.14*4*theta/180));
  // //7th
  // draw_segment(model_transform, pointer, graphics_state, 6*theta, per_segment_length, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180)+per_segment_length*Math.sin(-3.14*3*theta/180)+per_segment_length*Math.sin(-3.14*4*theta/180)+per_segment_length*Math.sin(-3.14*5*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180)+per_segment_length*Math.cos(3.14*3*theta/180)+per_segment_length*Math.cos(3.14*4*theta/180)+per_segment_length*Math.cos(3.14*5*theta/180));
  // //8th
  // draw_segment(model_transform, pointer, graphics_state, 7*theta, per_segment_length, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180)+per_segment_length*Math.sin(-3.14*3*theta/180)+per_segment_length*Math.sin(-3.14*4*theta/180)+per_segment_length*Math.sin(-3.14*5*theta/180)+per_segment_length*Math.sin(-3.14*6*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180)+per_segment_length*Math.cos(3.14*3*theta/180)+per_segment_length*Math.cos(3.14*4*theta/180)+per_segment_length*Math.cos(3.14*5*theta/180)+per_segment_length*Math.cos(3.14*6*theta/180));
  //draw 1th
...
function draw_bee(model_transform, pointer, graphics_state, t)
{
  ...
  draw_sphere(mult(model_transform, translation(2,0,0)), pointer, graphics_state);
  //wing rotation matrix
  var rotwr = rotation(70*Math.sin(t), [1,0,0]);
  var rotwl = rotation(70*Math.sin(-t), [1,0,0]);

  //right wing
  draw_right_wings(mult(mult(model_transform, translation(0,0,1)), rotwr), pointer, graphics_state);
  //left wing
  draw_left_wings(mult(mult(model_transform, translation(0,0,-1)), rotwl), pointer, graphics_state);
  ...
  { 'construct'( context )
    ...
    'display'( graphics_state )
      { 
        ...
        var orbital_spin = translation(10*Math.sin(1*t), 0, 5*Math.cos(1*t));
        var head_rot = rotation(360*t/(3.14*2), [0,1,0]);
        draw_bee(mult(mult(model_transform, orbital_spin), head_rot), this, graphics_state, t);
        model_transform = identity();
        draw_tree(model_transform, this, graphics_state, t);

        model_transform = identity();


        model_transform = mult(model_transform, scale(0.2,.2,.2));
