...
// function draw_tree(model_transform, pointer, graphics_state, t)
// {
//   //the coord origin is the root of the tree(stem)
//   var period = 5;
//   var max_deg = 10;
//   var per_segment_length = 1.1;
//   var theta = max_deg*Math.sin(2*3.14/period*t);//warning: this one is in degree!!!! be careful!!!
//   //draw 1th
//   draw_tree_segment(model_transform, pointer, graphics_state, 0, per_segment_length, 0, 0);
//   draw_tree_segment(model_transform, pointer, graphics_state, theta, per_segment_length, 0, per_segment_length);

//   //draw 3-8
//   var x_last = 0, y_last = 0;
//   for(i = 2; i<=7; i++)
//   {
//     draw_tree_segment(model_transform, pointer, graphics_state, i*theta, per_segment_length, x_last + per_segment_length*Math.sin(-3.14*(i-1)*theta/180), y_last + per_segment_length + per_segment_length*Math.cos(3.14*(i-1)*theta/180));
//     x_last = x_last + per_segment_length*Math.sin(-3.14*(i-1)*theta/180);
//     y_last = y_last + per_segment_length*Math.cos(3.14*(i-1)*theta/180);
//   }
//   //draw ball

//   draw_apple(model_transform, pointer, graphics_state, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180)+per_segment_length*Math.sin(-3.14*3*theta/180)+per_segment_length*Math.sin(-3.14*4*theta/180)+per_segment_length*Math.sin(-3.14*5*theta/180)+per_segment_length*Math.sin(-3.14*6*theta/180)+per_segment_length*Math.sin(-3.14*7*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180)+per_segment_length*Math.cos(3.14*3*theta/180)+per_segment_length*Math.cos(3.14*4*theta/180)+per_segment_length*Math.cos(3.14*5*theta/180)+per_segment_length*Math.cos(3.14*6*theta/180)+per_segment_length*Math.cos(3.14*7*theta/180) );
// }

// function draw_apple(model_transform, pointer, graphics_state, x, y)
// {
//   model_transform = mult(model_transform, translation(x,y,0));
//   //model_transform = mult(model_transform, translation(0, 1, 0));
//   pointer.shapes.ball.draw(graphics_state, model_transform, pointer.brown_clay);
// }

//Note: Approporiate order of transform: scale, transl, rot
//
// function draw_tree_segment(model_transform, pointer, graphics_state, degree, per_segment_length, x, y)
// {
//   model_transform = mult(model_transform, translation(x, y, 0)); //put back
//   model_transform = mult(model_transform, rotation(degree, [0,0,1]));//rotate
//   model_transform = mult(model_transform, translation(-x, -y, 0));//change the coord system (credit to prof's slides)
...
//   pointer.shapes.box.draw(graphics_state, model_transform, pointer.brown_clay);
// }

// function draw_leg_segment(model_transform, pointer, graphics_state, degree, per_segment_length, y, z)
// {
...
//   pointer.shapes.box.draw(graphics_state, model_transform, pointer.brown_clay);
// }
// function draw_rt_leg(model_transform, pointer, graphics_state, t)
// {
//   var per_segment_length = 1;
//   var max_deg = 50;
//   var period = 3;
//   var theta = Math.abs(max_deg*Math.sin(2*3.14/period*t));
//   draw_leg_segment(model_transform, pointer, graphics_state, theta, per_segment_length, 0, 0); //upper_leg
//   draw_leg_segment(model_transform, pointer, graphics_state, 2*theta, per_segment_length, -per_segment_length*Math.cos(theta*3.14/180), -per_segment_length*Math.sin(theta*3.14/180));
// }

// function draw_lt_leg(model_transform, pointer, graphics_state, t)
// {
//   var per_segment_length = 1;
//   var max_deg = 50;
//   var period = 3;
...
// function draw_box(model_transform, pointer, graphics_state)
// {
//   pointer.shapes.box.draw(graphics_state, mult(model_transform, scale(2,1,1)), pointer.yellow_clay);
// }

// function draw_sphere(model_transform, pointer, graphics_state)
// {
//   pointer.shapes.ball.draw(graphics_state, model_transform, pointer.brown_clay);
// }

// function draw_sphere_butt(model_transform, pointer, graphics_state)
// {
//   pointer.shapes.ball.draw(graphics_state, model_transform, pointer.fire);
// }

// function draw_bee(model_transform, pointer, graphics_state, t)
// {
//   draw_box(mult(model_transform, translation(1, 0, 0)), pointer, graphics_state);
//   draw_sphere(mult(model_transform, translation(4,0,0)), pointer, graphics_state);
//   //draw_sphere(mult(model_transform, translation(5,0,0)), pointer, graphics_state);
//   draw_sphere_butt(mult(mult(model_transform, translation(-3,0,0)), scale(2,1,1)), pointer, graphics_state);
//   //wing rotation matrix
//   var rotwr = rotation(70*Math.sin(10*t), [1,0,0]);
//   var rotwl = rotation(70*Math.sin(-10*t), [1,0,0]);

//   //right wing
//   draw_right_wings(mult(mult(model_transform, translation(0,1,1)), rotwr), pointer, graphics_state);
//   //left wing
//   draw_left_wings(mult(mult(model_transform, translation(0,1,-1)), rotwl), pointer, graphics_state);


//   draw_rt_leg(mult(model_transform, translation(2,-1,1)), pointer, graphics_state, t);
//   draw_rt_leg(mult(model_transform, translation(1,-1,1)), pointer, graphics_state, t);
//   draw_rt_leg(mult(model_transform, translation(0,-1,1)), pointer, graphics_state, t);

//   draw_lt_leg(mult(model_transform, translation(2.3,-1,-1)), pointer, graphics_state, t);
//   draw_lt_leg(mult(model_transform, translation(0.7,-1,-1)), pointer, graphics_state, t);
//   draw_lt_leg(mult(model_transform, translation(-0.3,-1,-1)), pointer, graphics_state, t);

//   //draw buttocks

//   // model_transform = mult(model_transform, scale(2,0,0));
//   // model_transform = mult(model_transform, translation(-2, 0, 0));
//   // pointer.shapes.ball.draw(graphics_state, model_transform, pointer.brown_clay);
// }

// function draw_right_wings(model_transform, pointer, graphics_state)
// {
//   model_transform = mult(mult(model_transform, translation(0,0,2)), scale(1,0.1,2));
//   pointer.shapes.ball.draw(graphics_state, model_transform, pointer.brown_clay);
// }

// function draw_left_wings(model_transform, pointer, graphics_state)
// {
//   model_transform = mult(mult(model_transform, translation(0,0,-2)), scale(1,0.1,2));
//   pointer.shapes.ball.draw(graphics_state, model_transform, pointer.brown_clay);
// }

// function draw_ground(model_transform, pointer, graphics_state)
// {
//   model_transform = mult(model_transform, scale(50,0.01,50));
//   pointer.shapes.box.draw(graphics_state, model_transform, pointer.greyPlastic);
// }
        ...
        this.define_data_members( { stars: context.shaders_in_use["Phong_Model"  ].material( Color( .5,.5,.5,1 ), .5, .5, .5, 40, context.textures_in_use["stars.png"] ),
                                    ...
                                    greyPlastic  : context.shaders_in_use["Phong_Model" ].material( Color( .5,.5,.5, 1 ), .4, .8, .4, 20 ),
                                     brown_clay: context.shaders_in_use["Phong_Model"].material( Color( .5, .5, .3, 1 ), .2, 1,  1, 40 )
                                      ,fire         : context.shaders_in_use["Funny_Shader"].material(Color( 1, 1, 1, 1 ), .2, 1,  1, 40)
                                   } );
      },
    'display'( graphics_state )
      { 
        ...
        var mv_x = translation(1.3*t, 0, 0), mv_y = translation(0, 0.5*Math.sqrt(t)*Math.sin(t), 0), tilt_spin   = rotation( 70*t, [          1,          0,             0 ] );
        var orbital_spin = translation(10*Math.sin(1*t), 0, 10*Math.cos(1*t));
        var head_rot = rotation(t*180/3.14, [0,1,0]);
        this.draw_bee(mult(mult(mult(model_transform, translation(0,5+2*Math.sin(2*t),0)), orbital_spin), head_rot), graphics_state, t);

        this.draw_tree(mult(model_transform,translation(0,0,0)), graphics_state, t);

        this.draw_ground(model_transform, graphics_state);



      },//checked
    'draw_tree' (model_transform, graphics_state, t)
    {
        //the coord origin is the root of the tree(stem)
        var period = 1;
        var max_deg = 10;
        ...
        var theta = max_deg*Math.sin(2*3.14/period*t);//warning: this one is in degree!!!! be careful!!!
        //draw 1th
        this.draw_tree_segment(model_transform, graphics_state, 0, per_segment_length, 0, 0);
        this.draw_tree_segment(model_transform, graphics_state, theta, per_segment_length, 0, per_segment_length);

        //draw 3-8
        var x_last = 0, y_last = 0;
        for(i = 2; i<=7; i++)
        {
          this.draw_tree_segment(model_transform, graphics_state, i*theta, per_segment_length, x_last + per_segment_length*Math.sin(-3.14*(i-1)*theta/180), y_last + per_segment_length + per_segment_length*Math.cos(3.14*(i-1)*theta/180));
          x_last = x_last + per_segment_length*Math.sin(-3.14*(i-1)*theta/180);
          y_last = y_last + per_segment_length*Math.cos(3.14*(i-1)*theta/180);
        }
        //draw ball

        this.draw_apple(model_transform, graphics_state, per_segment_length*Math.sin(-3.14*theta/180) + per_segment_length*Math.sin(-3.14*2*theta/180)+per_segment_length*Math.sin(-3.14*3*theta/180)+per_segment_length*Math.sin(-3.14*4*theta/180)+per_segment_length*Math.sin(-3.14*5*theta/180)+per_segment_length*Math.sin(-3.14*6*theta/180)+per_segment_length*Math.sin(-3.14*7*theta/180), per_segment_length+per_segment_length*Math.cos(3.14*theta/180)+per_segment_length*Math.cos(3.14*2*theta/180)+per_segment_length*Math.cos(3.14*3*theta/180)+per_segment_length*Math.cos(3.14*4*theta/180)+per_segment_length*Math.cos(3.14*5*theta/180)+per_segment_length*Math.cos(3.14*6*theta/180)+per_segment_length*Math.cos(3.14*7*theta/180) );
      }, //checked
      'draw_apple' (model_transform, graphics_state, x, y)
      {
        model_transform = mult(model_transform, translation(x,y,0));
        //model_transform = mult(model_transform, translation(0, 1, 0));
        this.shapes.ball.draw(graphics_state, model_transform, this.brown_clay);
      },//checked
      'draw_tree_segment' (model_transform, graphics_state, degree, per_segment_length, x, y)
      {
        model_transform = mult(model_transform, translation(x, y, 0)); //put back
        model_transform = mult(model_transform, rotation(degree, [0,0,1]));//rotate
        model_transform = mult(model_transform, translation(-x, -y, 0));//change the coord system (credit to prof's slides)
      ...
      'draw_rt_leg'(model_transform, graphics_state, t)
      {
        var per_segment_length = 1;
        var max_deg = 50;
        var period = 3;
      ...
      'draw_box'(model_transform, graphics_state)
      {
        this.shapes.box.draw(graphics_state, mult(model_transform, scale(2,1,1)), this.yellow_clay);
      },//ch
      ...
      'draw_sphere_butt' (model_transform, graphics_state)
      {
        this.shapes.ball.draw(graphics_state, model_transform, this.fire);
      },//ch

      'draw_bee' (model_transform, graphics_state, t)
      {
        this.draw_box(mult(model_transform, translation(1, 0, 0)), graphics_state);
        this.draw_sphere(mult(model_transform, translation(4,0,0)), graphics_state);
        //draw_sphere(mult(model_transform, translation(5,0,0)), pointer, graphics_state);
        this.draw_sphere_butt(mult(mult(model_transform, translation(-3,0,0)), scale(2,1,1)), graphics_state);
        //wing rotation matrix
        var rotwr = rotation(70*Math.sin(10*t), [1,0,0]);
        var rotwl = rotation(70*Math.sin(-10*t), [1,0,0]);

        //right wing
        this.draw_right_wings(mult(mult(model_transform, translation(1,1,1)), rotwr), graphics_state);
        //left wing
        this.draw_left_wings(mult(mult(model_transform, translation(1,1,-1)), rotwl), graphics_state);


        this.draw_rt_leg(mult(model_transform, translation(2,-1,1)), graphics_state, t);
        this.draw_rt_leg(mult(model_transform, translation(1,-1,1)), graphics_state, t);
        this.draw_rt_leg(mult(model_transform, translation(0,-1,1)), graphics_state, t);

        this.draw_lt_leg(mult(model_transform, translation(2.3,-1,-1)), graphics_state, t);
        this.draw_lt_leg(mult(model_transform, translation(0.7,-1,-1)), graphics_state, t);
        this.draw_lt_leg(mult(model_transform, translation(-0.3,-1,-1)), graphics_state, t);
      ...
      'draw_right_wings' (model_transform, graphics_state)
      {
        model_transform = mult(mult(model_transform, translation(0,0,2)), scale(1,0.02,2));
        this.shapes.box.draw(graphics_state, model_transform, this.brown_clay);
      },//ch

      'draw_left_wings' (model_transform, graphics_state)
      {
        model_transform = mult(mult(model_transform, translation(0,0,-2)), scale(1,0.02,2));
        this.shapes.box.draw(graphics_state, model_transform, this.brown_clay);
      },//ch
