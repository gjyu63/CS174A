  ...
  { 'construct'( context )
    ...
    'display'( graphics_state )
      { 
        ...
        var orbital_spin = translation(5*Math.sin(1*t), 0, 5*Math.cos(1*t));
        var head_rot = rotation(t*180/3.14, [0,1,0]);

        draw_bee(mult(mult(mult(model_transform, translation(0,5+2*Math.sin(2*t),0)), orbital_spin), head_rot), this, graphics_state, t);

        draw_tree(mult(model_transform,translation(0,1,0)), this, graphics_state, t);

        draw_ground(model_transform, this, graphics_state);
