...
Declare_Any_Class( "Bee_Scene",  // An example of drawing a hierarchical object using a "model_transform" matrix and post-multiplication.
  { 
    ...
    'construct'( context )
      ...
      { 
        controls.add( "p", this, function() {  if(fblock==0) walk = 1; } ); controls.add( "p", this, function() { walk =  0; }, {'type':'keyup'});
        controls.add( "l", this, function() { if(fblock == 0) walk = -1; } ); controls.add( "l", this, function() { walk =  0; }, {'type':'keyup'});
        controls.add( "Space", this, function() { if(fly==0)jump = 1;} ); 
        controls.add( "Space", this, function() { jump =  0; }, {'type':'keyup'});
      },
    'display'( graphics_state )
      { 
        ...
        graphics_state.lights = [ new Light( vec4(  30,  30,  34, 1 ), Color( 0, .4, 0, 1 ), 100000 ),      // Arguments to construct a Light(): Light source position or 
            ...
            console.log(bally-1-2*(block_height[get_z_unit(ballz)]+1)-1);
            //free fall when drop
            ...
            //console.log(bally*1-block_height[get_z_unit(ballz)]-2);
            ...
            //graphics_state.camera_transform = lookAt([10, 10, ballz+20], [0,bally,ballz], [0,1,0]);

            /*end of the camera controller*/


            /*draw*/
            //this.draw_ball(graphics_state, model_transform);
            this.draw_turtle(graphics_state, model_transform);
            this.draw_bee(model_transform, graphics_state, t);
      },
      ...
      'draw_turtle'(graphics_state, model_transform)
      {
        this.shapes.semi_sphere.draw(graphics_state, model_transform, this.tut);
      },
