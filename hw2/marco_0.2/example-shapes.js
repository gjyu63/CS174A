...
{ 'populate'()                  // vector, and texture-space coordinate.
                  {
                  this.positions.push(vec3(1,3,1), vec3(2,0,1), vec3(2,0,2),
                                      vec3(0,0,2), vec3(0,0,0));
                              
                                        
                  this.normals.push(vec3(1, 1, -2), vec3(-1, 1, 0), vec3(0, 1, -1),
                                    vec3(3, -1, 0), vec3(0 ,1, 0));

                  this.texture_coords.push(vec2(.5,.5), vec2(0,.5), vec2(1,.5),
                                           vec2(.25,.067),vec2(.15,.15));

                  this.indices.push(0, 1, 2,    0, 3, 2,   1, 4, 0,   0, 3, 4,   2, 3, 1,   
                                    1, 4, 3,);
